import{d as p,m as h,c as f,b as m,E as S,r as y,e as u,f as L,i as d,g as w}from"./assets/header-modal-11929834.js";import"./assets/vendor-c4bdd18a.js";const x=document.querySelector(".favorites-page"),b=document.querySelector(".header-section");b.classList.add("header-section-favorites");x.classList.add("active-page");p();h();f();m();const n=document.querySelector(".favorites-list"),v=`<div class="favorites-no-results"><img
