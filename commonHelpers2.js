import{E as d,i as r}from"./assets/api-service-01af4489.js";import"./assets/vendor-c4bdd18a.js";const l=document.querySelector(".navigation__links--box");l.lastElementChild.classList.add("active-page");function u(){const e=JSON.parse(localStorage.getItem("quoteObj"));document.querySelector(".quote-text").innerHTML=e.quote,document.querySelector(".quote-author").innerHTML=e.author}u();const v=document.querySelector(".favorites-list");document.querySelector(".favorites-div-without-cards");const a=document.querySelector(".favorites-div-without-cards "),o="favoriteExerciseIds",p=new d;function g(e){console.log(e);const s=e.map(t=>`
