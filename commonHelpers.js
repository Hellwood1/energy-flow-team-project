...
`,M=()=>{f.error({message:"Ooops...Something happen. Please, try again later",backgroundColor:"rgb(240, 115, 115)",messageColor:"white",maxWidth:300,position:"center",timeout:3e3,progressBar:!1,transitionIn:"bounceInRight",transitionOut:"fadeOutLeft",messageSize:14})},E=e=>{f.success({message:e,messageColor:"white",maxWidth:300,position:"center",timeout:3e3,progressBar:!1,transitionIn:"bounceInRight",transitionOut:"fadeOutLeft",messageSize:14})},H=e=>{f.error({message:e,backgroundColor:"rgb(240, 115, 115)",messageColor:"white",maxWidth:300,position:"center",timeout:3e3,progressBar:!1,transitionIn:"bounceInRight",transitionOut:"fadeOutLeft",messageSize:14})},he=()=>{f.success({message:"Thank you for your feedback",backgroundColor:"green",messageColor:"white",maxWidth:300,position:"center",timeout:4e3,progressBar:!1,transitionIn:"bounceInRight",transitionOut:"fadeOutLeft",messageSize:14})},ve=()=>{f.error({message:"Such email already exists",backgroundColor:"rgb(240, 115, 115)",messageColor:"white",maxWidth:300,position:"center",timeout:3e3,progressBar:!1,transitionIn:"bounceInRight",transitionOut:"fadeOutLeft",messageSize:14})},fe=(e,t="hidden")=>{e.classList.add(t)},ye=(e,t="hidden")=>{e.classList.remove(t)};let l=1,A="test";document.querySelector(".navigation-list-form");const N=document.querySelector(".exercises-navigation-list");function xe(e,t){let s=[];if(e<5)for(let n=1;n<=e;n++)s.push(n);else e>=5&&t<=3?s=[1,2,3,4,"...",e]:e>=5&&e-t<=2?s=[1,"...",e-3,e-2,e-1,e]:s=[1,"...",t-1,t,parseInt(t)+1,"...",e];return s}function I(e,t){const s=xe(e,t).map(n=>`<li class="exercises-navigation-item">
    ...
    </li>`).join("")}function C(e){u.classList.add("exercise-list"),u.innerHTML=e}function Ie(e){const t=document.querySelector(".exercises-title"),s=document.querySelector(".exercises-path-name");t.textContent="Exercises /",s.textContent=e,s.classList.remove("hidden")}function $e(e){e.preventDefault(),$(),Q()}function Q(){w=!0;const e=P.firstElementChild.value;new h().getExercisesByKeyWord(S,y,e,l,G).then(s=>{if(s.results.length<=0)return be(),C('<li class="exercises-not-found-msg">Unfortunately, <span>no results</span> were found. You may want to consider other search options to find the exercise you are looking for. Our range is wide and you have the opportunity to find more options that suit your needs.</li>');I(s.totalPages,l);const n=_(s.results);C(n)})}function Be(){const e=P.firstElementChild.value,t=document.querySelector(".exercises-search-close-btn");e?(t.classList.remove("hidden"),t.addEventListener("click",T)):X()}function X(){const e=document.querySelector(".exercises-search-close-btn");e.classList.add("hidden"),e.removeEventListener("click",T)}function T(){w=!1,P.reset(),X()}function Pe(e){return e.length>=9?e.slice(0,9)+"...":e}document.querySelector(".categories-list").addEventListener("click",Te);function Te(e){if(!document.querySelector(".exercises-path-name").classList.contains("hidden")){const t=e.target.id;Ce(t)}}const u=document.querySelector(".categories-list"),Re=document.querySelector(".category-btns-list"),ee=document.querySelector(".exercises-title"),b=document.querySelector(".exercises-path-name"),Oe=document.querySelector(".navigation-list-form"),Fe=document.querySelector(".footer-subscription"),Ae=()=>{const e=document.querySelectorAll(".category-btn");e.forEach(t=>t.addEventListener("click",()=>{e.forEach(s=>ye(s,"current-category-btn")),fe(t,"current-category-btn")}))},R=async e=>{const t=new h,s=window.innerWidth<768?8:12;e=document.querySelector(".current-category-btn").textContent.trim();try{const n=await t.getCategoriesByFilter(e,l,s);I(n.totalPages,l),u.innerHTML=me(n),u.addEventListener("click",J),Oe.addEventListener("submit",we),j(u)}catch{M()}},W=async e=>{const t=e.target.textContent.trim();$(),De(),await R(t),u.classList.contains("exercise-list")&&u.classList.remove("exercise-list")};function De(){b.textContent!==""&&(ee.textContent="Exercises",b.textContent="",b.classList.add("hidden"),ke())}const We=()=>{window.addEventListener("load",Ae),window.addEventListener("load",R),Re.addEventListener("click",W),ee.addEventListener("click",W),Fe.addEventListener("submit",Ee)},ze=document.querySelector("[data-modal-open]"),Ve=document.querySelector("[data-modal-close]"),q=document.querySelector(".mobile-menu-wrapper"),He=document.querySelector(".home-page");He.classList.add("active-page");let Ne={37:1,38:1,39:1,40:1};function g(e){e.preventDefault()}function te(e){if(Ne[e.keyCode])return g(e),!1}let se=!1;try{window.addEventListener("test",null,Object.defineProperty({},"passive",{get:function(){se=!0}}))}catch{}let x=se?{passive:!1}:!1,ne="onwheel"in document.createElement("div")?"wheel":"mousewheel";function Ue(){window.addEventListener("DOMMouseScroll",g,!1),window.addEventListener(ne,g,x),window.addEventListener("touchmove",g,x),window.addEventListener("keydown",te,!1)}function Ke(){window.removeEventListener("DOMMouseScroll",g,!1),window.removeEventListener(ne,g,x),window.removeEventListener("touchmove",g,x),window.removeEventListener("keydown",te,!1)}const z=()=>q.classList.contains("none")?Ke():Ue(),V=()=>{ze.addEventListener("click",()=>{q.classList.toggle("none"),z()}),Ve.addEventListener("click",()=>{q.classList.toggle("none"),z()})},je=()=>{if(V())return V()},k=document.querySelector(".up-btn");k.addEventListener("click",Ge);window.onscroll=function(){ie()};function ie(){document.documentElement.scrollTop>2e3?k.style.display="block":k.style.display="none"}function Ge(){document.documentElement.scrollTop=0}je();We();ge();Se();ie();
